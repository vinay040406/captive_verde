  ...
  return (
    <div className="xl:px-0 px-4">
      <div
        ...
        className="max-w-285 w-full mx-auto px-4 xl:px-0 py-8 sm:py-15 flex items-center flex-col gap-8 bg-cover bg-center bg-no-repeat mt-15 sm:mt-24 lg:mt-35 rounded-xl"
      >
